...
# 데이터셋 설정
parser.add_argument('--dataset_name', type=str, default='financial', choices=['financial'])
parser.add_argument('--data', type=str, default='./datasets/MK2000_with_macro_and_volatility.csv', help='location of the data file')
